...
export const TIMELINE_EVENTS: TimelineEvent[] = [
  ...
  { id: "t3", time: "11:00 AM", title: "AI crop scan detected fungal symptoms", detail: "A crop scan on Zone D returned a 94% confidence match for Early Blight, Moderate severity.", icon: "virus", severity: "high", relatedField: "Zone D", relatedType: "scan", relatedRoute: "/scanner" },
